...
<div class="container">
    <form action="/purchase/{{$item->id}}" class="buy" id="stripe-form" method="post">
        ...
        <div class="buy__left">
            ...
            <div class="purchases">
                <div class="purchase">
                    ...
                    <select name="payment_method" id="payment" class="purchase__value">
            ...
            <div class="buy__info">
                <table>
                    ...
                    <tr>
                        ...
                        <td id="pay_confirm" class="table__data">コンビニ支払い</td>
                    </tr>
                </table>
            </div>
            @csrf
...
<!-- Stripeの決済システムをウェブページに組み込むためのもの -->
